...
const { doPostprocessing } = require('hhp-util/post-processing')
...
const gameIDRx = /^[*]+ +(?:888poker|Cassava|888poker Snap Poker) +Hand History for Game +(\d+) +[*]+/i
